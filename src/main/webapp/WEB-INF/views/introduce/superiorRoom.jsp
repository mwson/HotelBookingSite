...
<div class="room-details-slider">
    <div class="container">
        <div class="room__details__pic__slider owl-carousel">
            <div class="room__details__pic__slider__item set-bg" data-setbg="images/rooms/details/rd-2.png"></div>
            ...
            <div class="col-lg-12">
                <div class="room__details__content">
                    ...
                    <div class="room__details__desc">
                        <p>
                           	그렌 호텔의 스탠다드 슈페리어 룸은 안정감을 주는 베이지그레이 및 화이트 컬러를 기본으로 한 화려한 분위기의
                            BABEY MOULTON 사, 모던한 감각에 세련된 오리엔탈 무드를 가미한 HBA 사의 각기 다른 두 종류의 인테리어 객실로 준비되어 있습니다.
						</p>
                        <p>
