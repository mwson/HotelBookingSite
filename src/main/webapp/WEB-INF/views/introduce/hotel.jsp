...
<div class="breadcrumb-option set-bg" data-setbg="images/hbg-2.jpg">
    <div class="container">
        <div class="row">
...
<section class="about spad">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="section-title">
                        <h5>개요</h5>
                        <h2>그린호텔에 오신걸 환영합니다.</h2>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="about__text">
                        <h5>그린호텔은 투숙객의 편의를 위해 최선을 다하고 있습니다.</h5>
                        <p>
							그린호텔이 제공하는 편의시설들을 소개해드리고자 합니다.
                            <br>
                           	최고의 추억으로 만들어 드리겠습니다.
                        </p>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="services__item">
                    <img src="images/services/services-5.png" alt="">
                    <h4>TV HD</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="services__item">
                    <img src="images/services/services-6.png" alt="">
                    <h4>Restaurant</h4>
...
<div class="chooseus spad set-bg" data-setbg="images/history/chooseus-bg.png">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5">
                    <div class="history__item left__item">
                        ...
                        <span>1980년 4월</span>
                        <h4>호텔 창립</h4>
                        <img src="images/history/history-1.png" alt="">
                        <p>
							당시 세련된 인테리어 디자인으로 화제가 된 저희 호텔은
							<br>
							창립 직후부터 국내외 투숙객들에게 많은 인기를 얻었습니다.
						</p>
                    </div>
                    <div class="history__item left__item mb-0">
                        ...
                        <span>1988년 6월 </span>
                        <h4>88서울 올림픽</h4>
                        <img src="images/history/history-3.png" alt="">
                        <p>
                        	88서울 올림픽이 한창이던 해, 국제올림픽위원회 고위인사들의
                        	<br>
                        	거처로 자리매김하는 영광을 누렸습니다.
                        </p>
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-2 col-md-5 offset-md-2">
                    <div class="history__item right__first__item">
                        ...
                        <span>1997년 3월</span>
                        <h4>야외수영장 건설</h4>
                        <img src="images/history/history-2.png" alt="">
                        <p>
                        	투숙객들의 열화와 같은 성원에 힘입어 7500제곱미터에 달하는
                        	<br>
                        	대규모 야외수영장 건설을 완료했습니다.
                        </p>
                    </div>
                    <div class="history__item mb-0">
                        ...
                        <span>2016년 12월</span>
                        <h4>이달의 호텔 선정</h4>
                        <img src="images/history/history-4.png" alt="">
                        <p>
                        	국내외 투숙객분들의 성원에 힘입어 서울시 관광청에서 뽑은
                        	<br>
                        	이달의 호텔로 선정되는 영광을 누렸습니다.
                        	<br>
                        	앞으로도 끊임없이 노력하는 그린호텔이 되겠습니다.
                        </p>
                    </div>
                </div>
            </div>
