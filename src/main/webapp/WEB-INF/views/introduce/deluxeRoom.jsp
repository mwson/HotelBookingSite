            ...
            <div class="col-lg-12">
                <div class="room__details__content">
                    ...
                    <div class="room__details__desc">
                        <p>
                        	넓은 실내 공간은 일반 호텔 객실과는 다른 여유와 품격을 느끼실 수 있으며, 충분한 공간의 드레스 룸, 격조 있는 서재, 아일랜드 스타일의 최고급 다이닝 공간은 오래 머물수록 감동을 더해갑니다.
                        </p>
                        <p>
                        	모던하고 세련된 인테리어와 쾌적하고 여유로운 공간으로 내 집 같은 편안함을 선사하는 럭셔리 룸입니다. 클럽 플로어의 다양한 혜택은 물론 국내 최고의 시설과 편안함을 경험해 보세요.
