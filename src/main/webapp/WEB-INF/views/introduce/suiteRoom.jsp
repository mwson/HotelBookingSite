...
<div class="room-details-slider">
    <div class="container">
        <div class="room__details__pic__slider owl-carousel">
            <div class="room__details__pic__slider__item set-bg" data-setbg="images/rooms/details/rd-1.png"></div>
            ...
            <div class="col-lg-12">
                <div class="room__details__content">
                    ...
                    <div class="room__details__desc">
                        <p>
                        	세계 각국의 국빈과 저명한 학자, 국내외 최정상의 VIP만을 위해 준비된 대한민국을 대표하는 그린 호텔의 스위트 룸은 응접실과 회의실,
                           	비서관 전용 객실 등의 최첨단 시설과 보안 시스템을 갖추고 있으며 최고 VIP만을 위한 세심한 서비스와 안전을 제공합니다.
                           	그린호텔 스위트 룸은 오직 당신만을 위해 준비된 최고급 호텔 서비스를 선사합니다.
						</p>
                        <p>
                        	최고 수준의 우아함, 섬세함, 럭셔리함과 함께, 그린 호텔만의 최상의 서비스를 경험할 수 있는 스위트룸은 최고급 가구만을 갖추었습니다.
                            ...
                            <div class="room__details__more__facilities">                           
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="room__details__more__facilities__item">
                                            <div class="icon"><img src="images/rooms/details/facilities/fac-4.png" alt=""></div>
                                            <h6>무제한 Wifi</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
