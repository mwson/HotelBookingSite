                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="admin_logout_user_index"><strong>그린호텔</strong></a> &copy;
                            </p>
                        </div>
                        <div class="col-6 text-end">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a class="text-muted" href="admin_logout"><i class="align-middle me-1" data-feather="log-out"></i> 로그아웃</a>
                                </li>
                            </ul>
                        </div>
                    </div>
